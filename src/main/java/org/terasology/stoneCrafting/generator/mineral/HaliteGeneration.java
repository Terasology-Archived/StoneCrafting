 ...
 */
package org.terasology.stoneCrafting.generator.mineral;
...
public class HaliteGeneration extends PocketStructureDefinition implements OreDefinition {
    public HaliteGeneration() {
        super(new UniformPocketBlockProvider(CoreRegistry.get(BlockManager.class).getBlock("Stonecrafting:Halite")),
