...
public class StonecraftingCategory implements HelpCategory {
    private final String name = "Stonecrafting";
    ...
    public StonecraftingCategory() {
    }

    public StonecraftingCategory(ItemsCategoryInGameHelpRegistry itemsCategoryInGameHelpRegistry) {
