...
public class RegisterStonecraftingRecipes extends BaseComponentSystem {
    ...
    public void initialise() {
        workstationRegistry.registerProcessFactory(Stonecrafting.BASIC_STONECRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Stonecrafting.NOVICE_STONECRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
        workstationRegistry.registerProcessFactory(Stonecrafting.STANDARD_STONECRAFTING_PROCESS,
                new CraftingWorkstationProcessFactory());
    ...
    private void addWorkstationFormingRecipes() {
        multiBlockFormRecipeRegistry.addMultiBlockFormItemRecipe(
                new UniformMultiBlockFormItemRecipe(new ToolTypeEntityFilter("hammer"), new UseOnTopFilter(),
                        new StationTypeFilter("Stonecrafting:BasicStonecraftingStation"), new Basic3DSizeFilter(2, 1,
                        1, 1),
                        "Stonecrafting:BasicStonecraftingStation",
                        new UniformBlockReplacementCallback<Void>(blockManager.getBlock("Stonecrafting" +
                                ":BasicStoneStation"))));
    }

    private void addBasicStoneWorkstationBlockShapeRecipes() {
        addWorkstationBlockShapesRecipe(Stonecrafting.BASIC_STONECRAFTING_PROCESS, "Building|Cobble " +
                        "Stone|Stonecrafting:CobbleBlock",
                "Woodcrafting:stone", 2, "hammer", 1, "CoreAssets:CobbleStone", 1);
        addWorkstationBlockShapesRecipe(Stonecrafting.STANDARD_STONECRAFTING_PROCESS, "Building|Bricks|Stonecrafting" +
                        ":BrickBlock",
